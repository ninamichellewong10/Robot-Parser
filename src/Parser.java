...
public class Parser {
	...
	static Pattern ACTION = Pattern.compile("move|takeFuel|turnL|turnR|turnAround|wait|shieldOn|shieldOff");	
	...
	static Pattern CONDITION = Pattern.compile("and|or|not|lt|gt|eq");
	...
	static Pattern OPERATION = Pattern.compile("add|sub|mul|div");
